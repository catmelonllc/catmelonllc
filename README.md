...
<!--
Replace IMAGE_1_URL, IMAGE_2_URL, and IMAGE_3_URL with the actual image addresses or GitHub CDN links.
To use Roboto Mono, add a <link> to Google Fonts in your site or reference it via CSS if possible.
-->